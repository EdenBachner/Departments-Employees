...
public interface DepartmentApi {
	...
	public ResponseEntity<?> deleteDepartment(@ApiParam(required = true, value = "ID of the Department to delete", example = "0") @RequestParam long id);
	...
	public ResponseEntity<?> getDepartment(@ApiParam(required = true, value = "ID of the Department to return", example = "0") @RequestParam long id);
