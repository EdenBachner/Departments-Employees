...
public interface EmployeeApi {
	...
	public ResponseEntity<?> updateEmployee(
			@ApiParam(required = true, value = "ID of the Employee to update", example = "0") @RequestParam long id,
	...
	public ResponseEntity<?> deleteEmployee(
			@ApiParam(required = true, value = "ID of the Employee to delete", example = "0") @RequestParam long id);
	...
	public ResponseEntity<?> getEmployee(
			@ApiParam(required = true, value = "ID of the Employee to return", example = "0") @RequestParam long id);
}
